...
<head>
    <meta charset="UTF-8">
    <title>📂 Lista de Categorías - Bike Store</title>
...
<div class="container mt-5">
    ...
    <div class="filter-container">
        <div>
            ...
            <?php if ($_SESSION['role'] === 'admin' || $_SESSION['role'] === 'user'): ?>
                <a href="router.php?page=categorias&action=crear" class="btn btn-custom">
    ...
    <div class="table-responsive">
        <table class="table table-hover align-middle text-center bg-white" id="categoriasTable">
            <thead>
                <tr>
                    <th>ID</th>
                    <th>Descripción</th>
                ...
                <tr>
                    ...
                    <td>
                        <?php if ($_SESSION['role'] === 'admin'): ?>
                            <a href="router.php?page=categorias&action=editar&id=<?= $row['category_id'] ?>" class="btn btn-warning btn-action">
                                <i class="bi bi-pencil-square"></i> Editar
                            </a>
                            <a href="router.php?page=categorias&action=eliminar&id=<?= $row['category_id'] ?>"
...
document.getElementById('searchInput').addEventListener('keyup', function() {
    ...
    rows.forEach(row => {
        ...
        row.style.display = (id.includes(filter) || desc.includes(filter)) ? '' : 'none';
    });
});
</script>
